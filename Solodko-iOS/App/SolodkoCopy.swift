...
enum SolodkoCopy {
    ...
    enum Home {
        ...
        static let chooseMatch = String(localized: "Which one?")
        static let cameraTitle = String(localized: "Frame your food or nutrition label")
        static let barcodeTitle = String(localized: "Center the barcode")
    ...
    enum Actions {
        ...
        static let noneOfThese = String(localized: "None of these")
        static let usePhoto = String(localized: "Use photo")
        static let useBarcode = String(localized: "Scan barcode")
